          ...
          {ImageList.map((itm) => (
            <div key={itm.id}>
              <div className="grid grid-cols-1 sm:grid-cols-2">
                {/* text content */}
                <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order- z-10">
                  <h1
                    data-aos="zoom-out"
                ...
                <div className="order-1 sm:order-2 ">
                  <div className="relative z-10">
                    <img
                      ...
                      src={itm.img}
                      alt="img1"
                      className="w-[300px] h-[300px] sm:h-[450px] sm:w-[450px] lg:scale-100  sm:scale-125 object-contain mx-auto"
                    />
                  </div>
                </div>
              </div>
